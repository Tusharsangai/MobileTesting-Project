...
import Demo.appiumFramework.Capability;
...
public class banjaraRide extends Capability{
		...
		public void bookNow() throws InterruptedException, IOException
		{
			//Runtime.getRuntime().exec("adb emukill");
//		    startserver().start();
...
//			
	       ...
	       AndroidElement bookNow=	(AndroidElement) driver.findElement(By.xpath("//*[@text='BOOK NOW']"));
		   ...
		   driver.findElementByAccessibilityId("27 May 2023").click();
...
//			driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
      ...
      public void callUs() {
    	  taction.tap(TapOptions.tapOptions().withElement(ElementOption.element(driver.findElement(MobileBy.AndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true)).scrollIntoView(new UiSelector().text(\"Call Us\"))"))))).perform();
			...
			taction.press(PointOption.point(300, 1400)).waitAction().moveTo(PointOption.point(1050, 1400)).release().perform();
			taction.press(PointOption.point(500, 1400)).waitAction().moveTo(PointOption.point(1050, 1400)).release().perform();
	...
	public void aboutUs() throws InterruptedException {
     ...
     @Test(enabled=true , priority=4)
		public void Profile() throws InterruptedException{
		     ...
		     driver.findElementById("com.forbinary.banjararide:id/edtInputProfile").sendKeys("Kaushik Biswas");
